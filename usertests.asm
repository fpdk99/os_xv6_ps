...
00000d90 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    wait();
     ...
     e53:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
00003170 <validateint>:
    ...
    3170:	c3                   	ret    
    3171:	eb 0d                	jmp    3180 <validatetest>
    3173:	90                   	nop
    3174:	90                   	nop
    3175:	90                   	nop
    3176:	90                   	nop
    ...
    33a5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test finished\n");
    ...
    3573:	5d                   	pop    %ebp
    3574:	c3                   	ret    
    3575:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
strchr(const char *s, char c)
{
  ...
  for(; *s; s++)
    ...
    3763:	90                   	nop
    3764:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  return 0;
    ...
    3782:	5d                   	pop    %ebp
    3783:	c3                   	ret    
    3784:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    378a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
